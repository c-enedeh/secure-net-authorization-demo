...
public class ApplicationDbContext : IdentityDbContext<IdentityUser>
{
    ...
    private void SeedData(ModelBuilder builder)
    {
        ...
        // Create users
        // These users will be seeded with the password "P@ssword1" (hashed).
        // In production avoid seeding default passwords and enforce strong password policies.
        ...
        // Hash the shared seed password for each user so the migration contains deterministic hashed values.
        const string seededPassword = "P@ssword1";
        adminUser.PasswordHash = hasher.HashPassword(adminUser, seededPassword);
        aliceUser.PasswordHash = hasher.HashPassword(aliceUser, seededPassword);
        bobUser.PasswordHash = hasher.HashPassword(bobUser, seededPassword);
